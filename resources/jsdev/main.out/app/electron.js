...
return [cljs.core.str("file://"),cljs.core.str(clojure.string.join.call(null,"/",new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [__dirname,filename], null)))].join('');
});
